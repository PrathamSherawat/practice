...
window = tk.Tk()
window.title('Sorting Visualizer - By Pratham Sherawat')
...
#Buttons
insert = tk.Button(window, text='Insertion Sort', command=insertion_sort,bg = "green", fg = "white", width=10, height=1)
select = tk.Button(window, text='Selection Sort', command=selection_sort,bg = "green", fg = "white", width=10, height=1)
bubble = tk.Button(window, text='Bubble Sort', command=bubble_sort,bg = "green", fg = "white", width=10, height=1)
